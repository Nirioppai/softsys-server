...
class OrganizationChartService {
    ...
    async createOneEvaluationForm(data: IEmployeeEvaluationSchema) {
        const isExistingEvaluationForm = await EvaluationModel.find({ evaluationName: data.employeeNumber });
    ...
    async updateOneEvaluationForm(data: IEmployeeEvaluationSchema, id: string) {
