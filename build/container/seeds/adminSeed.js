...
const AdminSeed = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield index_1.AdminModel.deleteMany({});
    ...
    for (let i = 0; i < 10; i++) {
        const admins = new index_1.AdminModel({
            adminId: '2021-' + faker_1.default.datatype.number(9999),
            name: {
    ...
    yield index_1.AdminModel.insertMany(adminAccounts);
    console.log('Seeding admin accounts ...');
});
exports.default = AdminSeed;
